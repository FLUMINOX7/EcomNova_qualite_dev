...
from backend.models_sql import InvoiceModel, InvoiceLineModel
import uuid
import time
...
class InvoiceRepository:
    ...
    def get_by_order(self, order_id: str) -> Optional[InvoiceModel]:
    ...
    def list_by_user(self, user_id: str) -> List[InvoiceModel]:
        ...
        ).order_by(InvoiceModel.issued_at.desc()).all()
